...
public class StreamingCameraView extends CameraView implements LifecycleEventListener, BarCodeScannerAsyncTaskDelegate, StreamingFaceDetectorAsyncTaskDelegate,
  ...
  public StreamingCameraView(ThemedReactContext themedReactContext) {
    ...
    addCallback(new Callback() {
      ...
      public void onCameraOpened(CameraView cameraView) {
        StreamingCameraViewHelper.emitCameraReadyEvent(cameraView);
      }

      @Override
      public void onMountError(CameraView cameraView) {
        StreamingCameraViewHelper.emitMountErrorEvent(cameraView, "Camera view threw an error - component could not be rendered.");
      }
      ...
      public void onPictureTaken(CameraView cameraView, final byte[] data) {
        ...
        if(Build.VERSION.SDK_INT >= 11/*HONEYCOMB*/) {
          new ResolveTakenPictureAsyncTask(data, promise, options, cacheDirectory, StreamingCameraView.this)
  ...
  public void onPictureSaved(WritableMap response) {
    StreamingCameraViewHelper.emitPictureSavedEvent(this, response);
  }
  ...
  public void record(ReadableMap options, final Promise promise, File cacheDirectory) {
    try {
      ...
      if (options.hasKey("quality")) {
        profile = StreamingCameraViewHelper.getCamcorderProfile(options.getInt("quality"));
      }
  ...
  private void initBarcodeReader() {
    ...
    if (mBarCodeTypes != null) {
      for (String code : mBarCodeTypes) {
        String formatString = (String) StreamingCameraModule.VALID_BARCODE_TYPES.get(code);
  ...
  public void onBarCodeRead(Result barCode) {
    ...
    StreamingCameraViewHelper.emitBarCodeReadEvent(this, barCode);
  }
  ...
  public void onFaceDetectionError(StreamingFaceDetector faceDetector) {
    ...
    StreamingCameraViewHelper.emitFaceDetectionErrorEvent(this, faceDetector);
  }
  ...
  public void onBarcodeDetectionError(StreamingBarcodeDetector barcodeDetector) {
    ...
    StreamingCameraViewHelper.emitBarcodeDetectionErrorEvent(this, barcodeDetector);
  }
  ...
  public void onTextRecognized(SparseArray<TextBlock> textBlocks, int sourceWidth, int sourceHeight, int sourceRotation) {
    ...
    StreamingCameraViewHelper.emitTextRecognizedEvent(this, textBlocksDetected, dimensions);
  }
  ...
  public void onHostResume() {
    if (hasCameraPermissions()) {
      ...
      StreamingCameraViewHelper.emitMountErrorEvent(this, "Camera permissions not granted - component could not be rendered.");
    }
  }
