...
public class StreamingCameraView extends CameraView implements LifecycleEventListener, BarCodeScannerAsyncTaskDelegate, FaceDetectorAsyncTaskDelegate,
    BarcodeDetectorAsyncTaskDelegate, TextRecognizerAsyncTaskDelegate, StreamingAsyncTaskDelegate, PictureSavedDelegate {
  ...
  public volatile boolean streamingLock = false;
  ...
  private boolean mShouldStreaming = false;
  ...
  public void setShouldStreaming(boolean shouldStreaming) {
    if (shouldStreaming && mMultiFormatReader == null) {
      initBarcodeReader();
    }
    this.mShouldStreaming = shouldStreaming;
    setScanning(mShouldDetectFaces || mShouldGoogleDetectBarcodes || mShouldScanBarCodes || mShouldRecognizeText || mShouldStreaming);
  }
