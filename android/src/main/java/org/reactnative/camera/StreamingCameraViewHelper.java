...
public class StreamingCameraViewHelper {
  ...
  public static int getCorrectCameraRotation(int rotation, int facing) {
    if (facing == StreamingCameraView.FACING_FRONT) {
  ...
  public static CamcorderProfile getCamcorderProfile(int quality) {
    ...
    switch (quality) {
      case StreamingCameraModule.VIDEO_2160P:
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
          profile = CamcorderProfile.get(CamcorderProfile.QUALITY_2160P);
        }
        break;
      case StreamingCameraModule.VIDEO_1080P:
        profile = CamcorderProfile.get(CamcorderProfile.QUALITY_1080P);
        break;
      case StreamingCameraModule.VIDEO_720P:
        profile = CamcorderProfile.get(CamcorderProfile.QUALITY_720P);
        break;
      case StreamingCameraModule.VIDEO_480P:
        profile = CamcorderProfile.get(CamcorderProfile.QUALITY_480P);
        break;
      case StreamingCameraModule.VIDEO_4x3:
        profile = CamcorderProfile.get(CamcorderProfile.QUALITY_480P);
