...
public class StreamingFileFaceDetectionAsyncTask extends AsyncTask<Void, Void, SparseArray<Face>> {
  ...
  private StreamingFaceDetector mStreamingFaceDetector;

  public StreamingFileFaceDetectionAsyncTask(Context context, ReadableMap options, Promise promise) {
  ...
  protected SparseArray<Face> doInBackground(Void... voids) {
    ...
    mStreamingFaceDetector = detectorForOptions(mOptions, mContext);
    ...
    StreamingFrame frame = StreamingFrameFactory.buildFrame(bitmap);
    return mStreamingFaceDetector.detect(frame);
  }
  ...
  protected void onPostExecute(SparseArray<Face> faces) {
    ...
    mStreamingFaceDetector.release();
    mPromise.resolve(result);
  }

  private static StreamingFaceDetector detectorForOptions(ReadableMap options, Context context) {
    StreamingFaceDetector detector = new StreamingFaceDetector(context);
