...
public class StreamingFrameFactory {
  public static StreamingFrame buildFrame(byte[] bitmapData, int width, int height, int rotation) {
    ...
    return new StreamingFrame(builder.build(), dimensions);
  }

  public static StreamingFrame buildFrame(Bitmap bitmap) {
    Frame.Builder builder = new Frame.Builder();
